...
create table Bills (
Id varchar(20) primary key not null,
Name Nvarchar(50) foreign key references Staffs(Name),
UserId varchar(20)  foreign key references Orders(UserId),
Money int,
Created_time Date default getdate()
)
...
Flowerld varchar(20) foreign key references Flowers(Id),
Amount int, 
Price int,
Money int,
Created_time Date default getdate()
